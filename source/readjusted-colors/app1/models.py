...
class User(models.Model):  # AbstractEmailUser):
    ...
    ide_snapshot = models.ImageField(upload_to='app1/static/app1/images/ide_snapshots/', null=True)
    video = models.FileField(upload_to='app1/static/app1/video/', null = True)
...
class MediaFiles(models.Model):
    ...
    media_file = models.ImageField(upload_to='app1/static/app1/images/media_files/', null=False)
