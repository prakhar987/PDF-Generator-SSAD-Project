...
#This function is to setup page
...
#This function is to set size of image of any size according to aspect ratio
...
#This function is to display images in pdf
...
#This fuction diplays basic information about candidate
...
def generate_table_for_a_section(ar, count1, elements, i1, sec, styles):
    if count1 > 1:
        ...
        for _ in ar:
            if var == 0:
                tattle.add('BACKGROUND', (0, var), (-1, var), colors.orange)
            elif var % 2 == 0:
        ...
        if sec[i1] == "paragraph":
            ...
            tattle.add('BACKGROUND', (0, 1), (-1, 1), colors.green)
            tattle.add('BACKGROUND', (0, 0), (-1, 0), colors.orange)
        t.setStyle(tattle)
        elements.append(t)
        elements.append(Spacer(1, 0.2 * inch))

#Table for different subsections
...
#Fuction for chat transcript portion
...
#Function of representation of data into form of pie charts
...
#This fuction sends mail to HR with pdf attached
